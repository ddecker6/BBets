...
Their average earnings are around 281.23. The 95% confidence interval is two standard deviations above the mean or below the mean. In this case, the below the mean is 223, and the above is 339.This is because two standard deviations adds up to ~58. The standard deviation for the problem is 28.97991, which rounds up to 29. We used favstats to find these numbers. 
